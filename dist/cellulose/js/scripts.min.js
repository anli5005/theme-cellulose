...
height:this.maxY};return this.options.isFitWidth&&(a.width=this._getContainerFitWidth()),a},d.prototype._getContainerFitWidth=function(){for(var a=0,b=this.cols;--b&&0===this.colYs[b];)a++;return(this.cols-a)*this.columnWidth-this.gutter},d.prototype.needsResizeLayout=function(){var a=this.containerWidth;return this.getContainerWidth(),a!==this.containerWidth},d});var CanvasImage=function(a){this.canvas=document.createElement("canvas"),this.context=this.canvas.getContext("2d"),document.body.appendChild(this.canvas),this.width=this.canvas.width=a.width,this.height=this.canvas.height=a.height,this.context.drawImage(a,0,0,this.width,this.height)};CanvasImage.prototype.clear=function(){this.context.clearRect(0,0,this.width,this.height)},CanvasImage.prototype.update=function(a){this.context.putImageData(a,0,0)},CanvasImage.prototype.getPixelCount=function(){return this.width*this.height},CanvasImage.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)},CanvasImage.prototype.removeCanvas=function(){this.canvas.parentNode.removeChild(this.canvas)};var ColorThief=function(){};if(ColorThief.prototype.getColor=function(a,b){var c=this.getPalette(a,5,b),d=c[0];return d},ColorThief.prototype.getPalette=function(a,b,c){"undefined"==typeof b&&(b=10),("undefined"==typeof c||1>c)&&(c=10);for(var d,e,f,g,h,i=new CanvasImage(a),j=i.getImageData(),k=j.data,l=i.getPixelCount(),m=[],n=0;l>n;n+=c)d=4*n,e=k[d+0],f=k[d+1],g=k[d+2],h=k[d+3],h>=125&&(e>250&&f>250&&g>250||m.push([e,f,g]));var o=MMCQ.quantize(m,b),p=o?o.palette():null;return i.removeCanvas(),p},!pv)var pv={map:function(a,b){var c={};return b?a.map(function(a,d){return c.index=d,b.call(c,a)}):a.slice()},naturalOrder:function(a,b){return b>a?-1:a>b?1:0},sum:function(a,b){var c={};return a.reduce(b?function(a,d,e){return c.index=e,a+b.call(c,d)}:function(a,b){return a+b},0)},max:function(a,b){return Math.max.apply(null,b?pv.map(a,b):a)}};var MMCQ=function(){function a(a,b,c){return(a<<2*i)+(b<<i)+c}function b(a){function b(){c.sort(a),d=!0}var c=[],d=!1;return{push:function(a){c.push(a),d=!1},peek:function(a){return d||b(),void 0===a&&(a=c.length-1),c[a]},pop:function(){return d||b(),c.pop()},size:function(){return c.length},map:function(a){return c.map(a)},debug:function(){return d||b(),c}}}function c(a,b,c,d,e,f,g){var h=this;h.r1=a,h.r2=b,h.g1=c,h.g2=d,h.b1=e,h.b2=f,h.histo=g}function d(){this.vboxes=new b(function(a,b){return pv.naturalOrder(a.vbox.count()*a.vbox.volume(),b.vbox.count()*b.vbox.volume())})}function e(b){var c,d,e,f,g=1<<3*i,h=new Array(g);return b.forEach(function(b){d=b[0]>>j,e=b[1]>>j,f=b[2]>>j,c=a(d,e,f),h[c]=(h[c]||0)+1}),h}function f(a,b){var d,e,f,g=1e6,h=0,i=1e6,k=0,l=1e6,m=0;return a.forEach(function(a){d=a[0]>>j,e=a[1]>>j,f=a[2]>>j,g>d?g=d:d>h&&(h=d),i>e?i=e:e>k&&(k=e),l>f?l=f:f>m&&(m=f)}),new c(g,h,i,k,l,m,b)}function g(b,c){function d(a){var b,d,e,f,g,h=a+"1",j=a+"2",k=0;for(i=c[h];i<=c[j];i++)if(o[i]>n/2){for(e=c.copy(),f=c.copy(),b=i-c[h],d=c[j]-i,g=d>=b?Math.min(c[j]-1,~~(i+d/2)):Math.max(c[h],~~(i-1-b/2));!o[g];)g++;for(k=p[g];!k&&o[g-1];)k=p[--g];return e[j]=g,f[h]=e[j]+1,[e,f]}}if(c.count()){var e=c.r2-c.r1+1,f=c.g2-c.g1+1,g=c.b2-c.b1+1,h=pv.max([e,f,g]);if(1==c.count())return[c.copy()];var i,j,k,l,m,n=0,o=[],p=[];if(h==e)for(i=c.r1;i<=c.r2;i++){for(l=0,j=c.g1;j<=c.g2;j++)for(k=c.b1;k<=c.b2;k++)m=a(i,j,k),l+=b[m]||0;n+=l,o[i]=n}else if(h==f)for(i=c.g1;i<=c.g2;i++){for(l=0,j=c.r1;j<=c.r2;j++)for(k=c.b1;k<=c.b2;k++)m=a(j,i,k),l+=b[m]||0;n+=l,o[i]=n}else for(i=c.b1;i<=c.b2;i++){for(l=0,j=c.r1;j<=c.r2;j++)for(k=c.g1;k<=c.g2;k++)m=a(j,k,i),l+=b[m]||0;n+=l,o[i]=n}return o.forEach(function(a,b){p[b]=n-a}),d(h==e?"r":h==f?"g":"b")}}function h(a,c){function h(a,b){for(var c,d=1,e=0;k>e;)if(c=a.pop(),c.count()){var f=g(i,c),h=f[0],j=f[1];if(!h)return;if(a.push(h),j&&(a.push(j),d++),d>=b)return;if(e++>k)return}else a.push(c),e++}if(!a.length||2>c||c>256)return!1;var i=e(a),j=0;i.forEach(function(){j++});var m=f(a,i),n=new b(function(a,b){return pv.naturalOrder(a.count(),b.count())});n.push(m),h(n,l*c);for(var o=new b(function(a,b){return pv.naturalOrder(a.count()*a.volume(),b.count()*b.volume())});n.size();)o.push(n.pop());h(o,c-o.size());for(var p=new d;o.size();)p.push(o.pop());return p}var i=5,j=8-i,k=1e3,l=.75;return c.prototype={volume:function(a){var b=this;return(!b._volume||a)&&(b._volume=(b.r2-b.r1+1)*(b.g2-b.g1+1)*(b.b2-b.b1+1)),b._volume},count:function(b){var c=this,d=c.histo;if(!c._count_set||b){var e,f,g,h=0;for(e=c.r1;e<=c.r2;e++)for(f=c.g1;f<=c.g2;f++)for(g=c.b1;g<=c.b2;g++)index=a(e,f,g),h+=d[index]||0;c._count=h,c._count_set=!0}return c._count},copy:function(){var a=this;return new c(a.r1,a.r2,a.g1,a.g2,a.b1,a.b2,a.histo)},avg:function(b){var c=this,d=c.histo;if(!c._avg||b){var e,f,g,h,j,k=0,l=1<<8-i,m=0,n=0,o=0;for(f=c.r1;f<=c.r2;f++)for(g=c.g1;g<=c.g2;g++)for(h=c.b1;h<=c.b2;h++)j=a(f,g,h),e=d[j]||0,k+=e,m+=e*(f+.5)*l,n+=e*(g+.5)*l,o+=e*(h+.5)*l;k?c._avg=[~~(m/k),~~(n/k),~~(o/k)]:c._avg=[~~(l*(c.r1+c.r2+1)/2),~~(l*(c.g1+c.g2+1)/2),~~(l*(c.b1+c.b2+1)/2)]}return c._avg},contains:function(a){var b=this,c=a[0]>>j;return gval=a[1]>>j,bval=a[2]>>j,c>=b.r1&&c<=b.r2&&gval>=b.g1&&gval<=b.g2&&bval>=b.b1&&bval<=b.b2}},d.prototype={push:function(a){this.vboxes.push({vbox:a,color:a.avg()})},palette:function(){return this.vboxes.map(function(a){return a.color})},size:function(){return this.vboxes.size()},map:function(a){for(var b=this.vboxes,c=0;c<b.size();c++)if(b.peek(c).vbox.contains(a))return b.peek(c).color;return this.nearest(a)},nearest:function(a){for(var b,c,d,e=this.vboxes,f=0;f<e.size();f++)c=Math.sqrt(Math.pow(a[0]-e.peek(f).color[0],2)+Math.pow(a[1]-e.peek(f).color[1],2)+Math.pow(a[2]-e.peek(f).color[2],2)),(b>c||void 0===b)&&(b=c,d=e.peek(f).color);return d},forcebw:function(){var a=this.vboxes;a.sort(function(a,b){return pv.naturalOrder(pv.sum(a.color),pv.sum(b.color))});var b=a[0].color;b[0]<5&&b[1]<5&&b[2]<5&&(a[0].color=[0,0,0]);var c=a.length-1,d=a[c].color;d[0]>251&&d[1]>251&&d[2]>251&&(a[c].color=[255,255,255])}},{quantize:h}}();!function(a){function b(){a(".post.has-post-thumbnail > .card-image").each(function(){var b=a(this),c=b.find("img");if(c.height()>.6*a(window).height()){var d=c.height(),e=.6*a(window).height(),f={start:(d-e)/2,end:(d+e)/2},g="rect("+f.start+"px,auto,"+f.end+"px,auto)";c.css({position:"absolute",top:-f.start+"px",left:0,clip:g}),b.height(e)}}),a("body").hasClass("masonry")&&e.masonry("layout")}function c(b){a(b).find(".placeholder-chip").remove(),a(b).each(function(){var b=a(this).find(".chip").removeClass("clipped-chip screen-reader-text"),c=a(this).find(".chip").filter(function(a){return b.eq(0).position().top!=b.eq(a<b.size()-1?a+1:a).position().top}).addClass("clipped-chip screen-reader-text");if(c.size()>0){var d=a('<span class="chip placeholder-chip" aria-hidden="true"></span>').text(c.size()).appendTo(a(this));d.prepend(a('<span class="material-icons">more_horiz</span>'));var e="";c.each(function(b){e+=a(this).clone().find(".material-icons").remove().end().text(),b<c.size()-1&&(e+=", ")}),d.attr("data-tooltip",e).tooltip({delay:0,position:"bottom"}),d.click(function(){a(this).parent().find(".clipped-chip").toggleClass("screen-reader-text").end().end().find(".material-icons").text(a(this).parent().find(".clipped-chip").hasClass("screen-reader-text")?"more_horiz":"chevron_left"),a("body.masonry > .main").masonry("layout")})}}),a("body.masonry > .main").masonry("layout")}function d(){for(var b=a(".site-navigation > ul li"),c=b.eq(0).find("i.material-icons").length>0,d=0,e=0;e<b.length;e++)d+=b.eq(e).outerWidth();if(d>a(".site-navigation").innerWidth()){if(console.log("Moo"),!c){var f=a('<li><i class="material-icons"></i></li>').css({position:"absolute",top:0,height:"100%",display:"block"}),g=f.clone();f.find(".material-icons").text("chevron_left").end().click(function(){a(this).parent().scrollLeft(a(this).parent().scrollLeft()-.5*a(window).width())}).css("left",0).prependTo(a("body > header > nav > ul")),g.find(".material-icons").text("chevron_right").end().click(function(){a(this).parent().scrollLeft(a(this).parent().scrollLeft()+.5*a(window).width())}).css("right",0).appendTo(a("body > header > nav > ul"))}}else c&&(b.eq(b.length-1).remove(),b.eq(0).remove())}var e;a(function(){a('.sidebar-trigger[data-activates="cellulose-sidebar"]').attr("href","#"),a("#cellulose-sidebar").css("transition","none"),a("a#sidenav-overlay").remove(),a(".sidebar-trigger").sideNav(),a("body.masonry").children(".main").append(a('<div class="sizer"></div>')),a("body").hasClass("masonry")&&(e=a("body > .main").addClass("masonry-grid").masonry({itemSelector:"article.card, div.cellulose-pagination",columnWidth:"body > .main > .sizer",percentPosition:!0,gutter:10}),e.imagesLoaded().progress(function(){e.masonry("layout")})),a(".entry-content .gallery .gallery-item").each(function(){a(this).width(a(this).find("img").width()).find("img").width("100%")}),a(".entry-content .gallery").children("br").remove().end().masonry({gutter:10}),a(".wp-caption").imagesLoaded().progress(function(b,c){var d=new ColorThief,e=d.getColor(c.img),f=brightness(e)>170,g=f?"rgba(0, 0, 0, 0.54)":"rgba(255, 255, 255, 0.7)",h=f?"rgba(0, 0, 0, 0.46)":"rgba(255, 255, 255, 0.5)";a(c.img).parent().siblings(".wp-caption-text").css("background-color",rgbtohex(e)).css("color",g).find("a").css("color",h)}),a(".gallery-icon").imagesLoaded().progress(function(b,c){a(".entry-content .gallery").masonry("layout");var d=new ColorThief,e=d.getColor(c.img),f=brightness(e)>170,g=f?"rgba(0, 0, 0, 0.54)":"rgba(255, 255, 255, 0.7)",h=f?"rgba(0, 0, 0, 0.46)":"rgba(255, 255, 255, 0.5)";a(c.img).parent().parent().siblings(".wp-caption-text").css("background-color",rgbtohex(e)).css("color",g).find("a").css("color",h)}),a(window).resize(b),a(".post.has-post-thumbnail > .card-image img").imagesLoaded().progress(function(a,c){b()});var f="body:not(.chip-clipping-off) .entry-taxonomies > div";a(f).resize(function(){c(f)}),a(window).resize(function(){d()}),d()}),a(window).load(function(){var a="body:not(.chip-clipping-off) .entry-taxonomies > div";c(a)})}(jQuery);